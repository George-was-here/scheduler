...
storiesOf("Appointment", module)
  ...
  .add("Error", () =>  <Error message="Could not delete appoint" onClose={action("onClose")} />)
  .add("Edit", () => <Form student="George" interviewer={3} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} />)
